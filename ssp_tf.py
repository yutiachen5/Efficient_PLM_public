...
from prose.ALLY.prediction_tf import SSPClassifier
...
def main():
    ...
    parser.add_argument('--path-test', default='/hpc/group/naderilab/eleanor/Efficient_PLM/data/CASP/NEW364.csv', help='path to testing dataset in csv format')
    parser.add_argument('--path-model', default='/hpc/group/naderilab/eleanor/Efficient_PLM/saved_models/rdm_d_1024/20250402_1832.sav', help='path to pretrained model')
